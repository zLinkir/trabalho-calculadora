	...
	public Menu() {
		...
		btnMultiplicacao.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				OperacoesMatematicas.setOperacao(OperacoesMatematicas.MULTIPLICACAO);
		...
		btnAdicao.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				OperacoesMatematicas.setOperacao(OperacoesMatematicas.SOMA);
				String valorSemPonto = tpDigitacao.getText().replace(".", "");
				if(!valorSemPonto.equals("")) {
					ValidacaoCalculadora.verificarAtribuicaoValorAtual(new BigDecimal(valorSemPonto));
				}
		...
		btnSubtracao.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				OperacoesMatematicas.setOperacao(OperacoesMatematicas.SUBTRACAO);
				String valorSemPonto = tpDigitacao.getText().replace(".", "");
				if(!valorSemPonto.equals("")) {
					ValidacaoCalculadora.verificarAtribuicaoValorAtual(new BigDecimal(valorSemPonto));
				}
		...
		btnCalcularResultado.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(OperacoesMatematicas.getOperacao() != null && OperacoesMatematicas.getValorAtual() != null) {
					String valorSemPonto = tpDigitacao.getText().replace(".", "");
					OperacoesMatematicas.calcular(new BigDecimal(valorSemPonto));
					tpDigitacao.setText(String.valueOf(OperacoesMatematicas.getValorAtual()));
					OperacoesMatematicas.setOperacao("");
					OperacoesMatematicas.setValorAtual(null);
				}
			}
		}); 
